...
/**
 * FBstabDense implements the Proximally Stabilized Semismooth Algorithms for
 * solving convex quadratic programs of the following form (1):
 *
 * min.    1/2  z'Hz + f'z
 * s.t.         Az <= b
 *
...
class FBstabDense {
 public:
   ...
   * taken prox_iters: Number of proximal iterations
   */
