...
/** 
 * A class that computes and stores residuals for inequality constrained dense QPs.
 * See dense_data.h for a description.
 * 
...
class DenseResidual{
 public:
	 ...
	 */
	void InnerResidual(const DenseVariable& x, const DenseVariable& xbar, double sigma);
